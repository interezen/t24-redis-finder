...
JDK="../jdk17"
MODULE_NAME="T24-REDIS-FINDER"
NOW=$(date +"%F")
LOG_DIR=logs
LOG_FILE=server_${NOW}.log
OPT="-Xms1g -Xmx1g -Xss256k"
OPT="${OPT} --add-exports=java.base/jdk.internal.misc=ALL-UNNAMED --add-exports=java.base/sun.nio.ch=ALL-UNNAMED --add-exports=java.management/com.sun.jmx.mbeanserver=ALL-UNNAMED --add-exports=jdk.internal.jvmstat/sun.jvmstat.monitor=ALL-UNNAMED --add-exports=java.base/sun.reflect.generics.reflectiveObjects=ALL-UNNAMED --add-opens=jdk.management/com.sun.management.internal=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED  --add-opens=java.base/java.lang.invoke=ALL-UNNAMED  --add-opens=java.base/java.io=ALL-UNNAMED  --add-opens=java.base/java.security=ALL-UNNAMED  --add-opens=java.base/java.util=ALL-UNNAMED  --add-opens=java.management/javax.management=ALL-UNNAMED  --add-opens=java.naming/javax.naming=ALL-UNNAMED "
DUMP="-Dlogback.configurationFile=./logback.xml -XX:+DisableExplicitGC -Djava.awt.headless=true -Djava.net.preferIPv4Stack=true -XX:+UseZGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=./ -XX:OnOutOfMemoryError=./restart.sh"
#######################################################################
